...
PhaseFeatureStatus1Form capture + simulated letter generation + copy to clipboard✅ Done2Live Gemini/OpenAI API call replacing the simulated template⬜ Not started2Server-side API key handling (required — see note below)⬜ Not started2"Generating…" loading state for real API latency⬜ Not started3Resume upload (PDF) + text extraction⬜ Not started3Resume-aware, personalized generation⬜ Not started
